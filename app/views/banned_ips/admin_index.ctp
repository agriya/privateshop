			...
			if (!empty($bannedIps)):
				...
				foreach ($bannedIps as $bannedIp):
					...
					<td class="select">
						...
						<td class="dl"><?php echo !empty($bannedIp['BannedIp']['reason'])?$this->Html->cText($bannedIp['BannedIp']['reason']):'';?></td>
						<td class="dl"><?php echo !empty($bannedIp['BannedIp']['redirect'])?$this->Html->cText($bannedIp['BannedIp']['redirect']):'';?></td>
